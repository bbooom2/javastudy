...
public class JSONMainClass {
	...
	public static void ex03() {
		...
		// 이걸 "" 안에 넣으면 자동으로 역슬래시 넣어 줌 {"name":"james","age":30,"height":180.5,"isAlive":true}
		...
		//JSONObject 객체를 구성하는 property 값 가져오기 
	...
	public static void ex04() {
       ...
       for(Object obj : products) { 
    	   JSONObject product = (JSONObject)obj; //캐스팅 
