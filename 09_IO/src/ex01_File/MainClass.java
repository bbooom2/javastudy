...
public class MainClass {
	...
	public static void ex01() {
		...
		if(dir.exists() == false) { 
			...
			//dir.deleteOnExit(); // JVM 실행이 끝날 때 지운다 
	...
	public static void ex03() throws IOException {
		...
		File file = new File(dir, "myfile.txt"); //파일 연결 
		if(file.exists() == false) {
			file.createNewFile();
		}
		...
		String lastModifiedDate = new SimpleDateFormat("yyyy-MM-dd").format(lastModified); //소문자 mm '분' 
