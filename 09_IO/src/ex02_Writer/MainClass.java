...
public class MainClass {
	...
	public static void ex02() { //골라서 보내기 
		...
		try (FileWriter fw = new FileWriter(file)) { //트라이옆에서 생성하는 경우에는 close 안 해도 됨
	...
	public static void ex03() {
		...
		try {
			...
			//보조스트림을 사용한 경우에는 보조 스트림만 닫으면 메인 스트림도 함께 닫힌다. 
			if(bw != null) {
				bw.close();
			}
		}catch(IOException e) {
	...
	public static void ex05() {
		...
		//디렉터리 생성 
		 File dir = new File("C:" + File.pathSeparator + "storage");
		 if(dir.exists() == false) {
			 dir.mkdirs();
		 }
