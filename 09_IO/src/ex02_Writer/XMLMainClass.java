...
public class XMLMainClass {
	 	...
	 	목표 
		 	...
		 	2. 내용 
		 		<products> //태그라고 부름 항상 태그는 시작과 끝이 있다 products의 부모는 product.xml (document) 그래서 document에 넣을것
		 					//이런 처리방식을 dom처리 방식이라 한다. 문서를 객체로 보는 것. 문서 자체는 다큐먼트로 보자. 문서에 들어가는 각종 태그들은 element라고 보자.
	...
	public static void main(String[] args) {
		...
		try {
			...
			DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance(); //다큐먼트빌더팩토리에서 만드는 건 다큐먼트빌더팩토리 
