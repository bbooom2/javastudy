...
public class JSONMainClass {
	...
	// 이걸 따옴표 안에 넣으면 자동으로 역슬래시 넣어 줌 {"name":"james","age":30,"height":180.5,"isAlive":true}
	
	public static void ex03() {
		
		// String 형식의 JASON 데이터 
		String str ="{\"name\":\"james\",\"age\":30,\"height\":180.5,\"isAlive\":true}";
		
		//JASONObject 객체 생성 
		JSONObject obj = new JSONObject(str);
		
		//JASONObject 객체를 구성하는 프로퍼티 값 가져오기 
	...
	public static void ex05() {
		...
		File file = new File(dir, "product.jason");
