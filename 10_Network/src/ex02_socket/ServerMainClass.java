...
//Inputstream : 한글 처리 못한다. 
//Outputstream : 한글 처리 못한다. 
//1. InputStreamReader, OutputStreamWriter로 변환해서 한글 처리하기 // 보편적 
//2. DataInputstream에 readUTF, DataOutputStream의 writeUTF로 한글 처리하기 
public class ServerMainClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// bind : ServerSocket에 InetSoketAddress 정보 전달 
			...
			while(true) {
				...
				DataOutputStream out = new DataOutputStream(clientSocket.getOutputStream()); //접속한 클라이언트로 데이터를 보내는 출력스트림
