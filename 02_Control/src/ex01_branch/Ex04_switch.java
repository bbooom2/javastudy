...
public class Ex04_switch {
	...
	public static void ex01() {
		int month = 1; //그만하라고 할 때까지 그 밑의 것들 다 처리 
		...
		case 3: 
		case 4: 
		case 5: System.out.println("봄"); break; // 봄을 출력하고 그만하세요 
		case 6: 
		case 7: 
		case 8: System.out.println("여름"); break;
		default: System.out.println("가을"); //break 안해도 됨. 마지막 실행문이기 때문. 넣어도 문제는 없음. 
		}
	}
